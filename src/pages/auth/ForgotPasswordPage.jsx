...
export default function ForgotPasswordPage() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();// src/pages/auth/ForgotPasswordPage.jsx
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-dark-50 dark:bg-dark-950 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="card p-8 dark:bg-dark-900 dark:border-dark-800">
          <Link
            to="/login"
          ...
          {sent ? (
            <div className="text-center py-4">
              <FiCheckCircle size={48} className="text-primary-500 mx-auto mb-4" />
